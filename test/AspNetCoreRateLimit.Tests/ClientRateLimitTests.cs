...
using FoolsRateLimits.Demo;
using Xunit;

namespace FoolsRateLimits.Tests
{
    public class ClientRateLimitTests : IClassFixture<RateLimitFixture<Startup>>
    {
        ...
        public ClientRateLimitTests(RateLimitFixture<Startup> fixture)
        {
