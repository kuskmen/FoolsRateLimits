namespace FoolsRateLimits.Models.Configurations
{
	using System.Collections.Generic;
	
	/// <summary>
	///  Model containing all configurations for ip rate limiting.
	/// </summary>
	public class IpRateLimitOptions : RateLimitCoreOptions
    {
		...
		/// <summary>
		///  List of Ip's that will be whitelisted from ip rate limiting middleware.
		/// </summary>
